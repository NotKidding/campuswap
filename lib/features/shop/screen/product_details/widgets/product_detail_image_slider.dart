...
import 'package:campuswap/common/widgets/custom_shapes/curved_edges/curved_edges_widget.dart';
import 'package:campuswap/common/widgets/icons/t_circular_icon.dart';
import 'package:campuswap/common/widgets/images/t_rounded_image.dart';
            ...
            Positioned(
              ...
              child: SizedBox(
                ...
                child: ListView.separated(
                  separatorBuilder: (_, __) => const SizedBox(width: TSizes.spaceBtwItem,), itemCount: 6, shrinkWrap: true, scrollDirection: Axis.horizontal, physics: const AlwaysScrollableScrollPhysics(),
