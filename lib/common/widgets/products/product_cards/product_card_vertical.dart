import 'package:campuswap/common/styles/shadows.dart';
...
import 'package:campuswap/features/shop/screen/product_details/product_detail.dart';
...
class TProductCardVertical extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //container with size padding, color, etc
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          boxShadow: [TShadowStyle.virticalProductShadow],
          borderRadius: BorderRadius.circular(TSizes.productImageRadius),
          color: dark ? TColors.darkGrey : TColors.white,
        ),
        child: Column( 
          children: [ 
            //thumbnail, wishlish, button
            TRoundedContainer(
              height: 180,
