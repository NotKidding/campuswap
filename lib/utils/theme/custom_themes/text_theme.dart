...
class TTextTheme{
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    labelLarge: const TextStyle().copyWith(fontSize: 24.0, fontWeight: FontWeight.normal, color: Colors.black),
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    labelLarge: const TextStyle().copyWith(fontSize: 24.0, fontWeight: FontWeight.normal, color: Colors.white),
